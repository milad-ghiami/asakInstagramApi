...
The following is a set of guidelines for contributing to the Instagram API, which is hosted in the [Instagram API repository](https://github.com/faizahmaddae/Instagram-API) on GitHub.
...
Please visit our [Project Task Tracker](https://github.com/faizahmaddae/Instagram-API/projects), where contributors can look at the list of available work. High-quality code contributions are greatly appreciated.
